                    ...
                    <div class="col-lg-6">
                        <nav class="header__menu">
                            <ul>
                                ...
                                <li class="active"><a href="shop-gridAdmin">Shop</a></li>
                                <li><a href="#">Pages</a>
                                    <ul class="header__menu__dropdown">
                                ...
                                <div class="price-range-wrap">
                                    ...
                                    <div class="range-slider">
                                        <div class="price-input">
                                            <input readonly type="text" id="minamount" name="min">
                                            <input readonly type="text" id="maxamount" name="max">
                                        </div>
                                    </div>
                                </div>
                            </div>
