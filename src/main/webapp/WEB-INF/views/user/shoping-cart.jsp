				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="header__top__right">
							...
							<div class="header__top__right__auth">
								<a href="login"><i class="fa fa-user"></i>${hoten}</a> <a
									href="register"><i class="fa fa-user"></i>Sign Up</a>
							</div>
						</div>
					</div>
				</div>
								...
								<tbody>
									<tr>
										<td class="shoping__cart__item"><img
											src="img/product/${item.images}" alt="">
											<h5>${item.name}</h5></td>
										<td class="shoping__cart__price">${item.price}</td>
										 <td class="shoping__cart__quantity">
											<div class="quantity">
												<div class="pro-qty">
													<input type="number" min="1" max="10" name="qty" value="${item.qty}" onblur="this.form.submit()">
												</div>
											</div>
										</td> 
										<td class="shoping__cart__total">${item.price * item.qty}K</td>
										<input type="hidden" name="id" value="${item.id}">
										<td
										 class="shoping__cart__item__close" >
										 <a href="/cart/remove/${item.id}"><span
											class="icon_close" onclick="removeItem(${item.id})"></span></a></td> 
									</tr>
								</tbody>
								</form>
							</c:forEach>
